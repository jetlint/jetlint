...
var All = []Metadata{
	...
	{ID: "no-control-regex", Category: CategoryCorrectness, Fix: FixNone, Stability: StabilityStable},
	...
	{ID: "no-misleading-character-class", Category: CategoryCorrectness, Fix: FixNone, Stability: StabilityStable},
