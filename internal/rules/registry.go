...
var All = []Metadata{
	...
	{ID: "no-empty-source", Category: CategorySuspicious, Fix: FixNone, Stability: StabilityStable},
	...
	{ID: "no-exports-in-test", Category: CategorySuspicious, Fix: FixNone, Stability: StabilityStable},
	...
	{ID: "no-redundant-use-strict", Category: CategorySuspicious, Fix: FixNone, Stability: StabilityStable},
	...
	{ID: "no-common-js", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-default-export", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-done-callback", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-enum", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-excessive-lines-per-function", Category: CategoryComplexity, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-excessive-nested-test-suites", Category: CategoryComplexity, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-exported-imports", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-head-element", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-implicit-boolean", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-namespace", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-negation-else", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-nested-ternary", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-non-null-assertion", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-parameter-assign", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-parameter-properties", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-process-env", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-restricted-globals", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-restricted-imports", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-restricted-types", Category: CategoryComplexity, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-shouty-constants", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-substr", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-this-in-static", Category: CategoryComplexity, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-unused-template-literal", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-useless-else", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-useless-type-constraint", Category: CategoryComplexity, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-void", Category: CategoryComplexity, Fix: FixNone, Stability: StabilityStable},
	{ID: "no-yoda-expression", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-array-literals", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-arrow-function", Category: CategoryComplexity, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-as-const-assertion", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-block-statements", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-collapsed-else-if", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-collapsed-if", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-consistent-array-type", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-consistent-arrow-return", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-consistent-builtin-instantiation", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-consistent-member-accessibility", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-consistent-object-definitions", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-consistent-type-definitions", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-date-now", Category: CategoryComplexity, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-default-parameter-last", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-enum-initializers", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-explicit-length-check", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-exponentiation-operator", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-exports-last", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-flat-map", Category: CategoryComplexity, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-for-of", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-fragment-syntax", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-grouped-accessor-pairs", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-index-of", Category: CategoryComplexity, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-literal-keys", Category: CategoryComplexity, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-max-params", Category: CategoryComplexity, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-node-assert-strict", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-nodejs-import-protocol", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-number-namespace", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-numeric-literals", Category: CategoryComplexity, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-numeric-separators", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-object-spread", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-react-function-components", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-shorthand-assign", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-shorthand-function-type", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-simple-number-keys", Category: CategoryComplexity, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-simplified-logic-expression", Category: CategoryComplexity, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-symbol-description", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-throw-new-error", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-throw-only-error", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
	{ID: "use-trim-start-end", Category: CategoryStyle, Fix: FixNone, Stability: StabilityStable},
}
